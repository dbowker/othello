...
${OBJECTDIR}/validMoves.o: validMoves.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/validMoves.o validMoves.cpp
...
${OBJECTDIR}/buildWorkRequest.o: buildWorkRequest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/buildWorkRequest.o buildWorkRequest.cpp
...
${OBJECTDIR}/setupBoard.o: setupBoard.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/setupBoard.o setupBoard.cpp

${OBJECTDIR}/findBestMove.o: findBestMove.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/findBestMove.o findBestMove.cpp
