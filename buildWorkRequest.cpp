...
char* buildWorkRequest(char* buffer, char b[], char color, char origColor, int depth, int possibleMove) {
	char *p;
	int i;
	...
	*p++ = origColor;
	...
	p = iToA(p,depth,10,2);  // my version of itoa returns the pos of null byte
